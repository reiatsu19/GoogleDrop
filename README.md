Google Drop is a Python tool that automatically fetches PDF invoices from Gmail and uploads them to a specific folder in Google Drive — skipping duplicates to keep things neat.
